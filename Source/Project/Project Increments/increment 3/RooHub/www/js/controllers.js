    ...
    $scope.listEvent = function() {
      ...
      $http({
        ...
        for (i = 0; i < list.length; i++) {
          ...
          console.log(userid);
          // $scope.myHTML =myHTML+eventname;
          $scope.myHTML +=userid+":" + eventname +"-"+ eventdescription + " " + "<br>";
...
//end of event controller
  ...
  .controller('CreateEventCtrl', function($scope, $state, $cordovaCalendar, $http, $window, $httpParamSerializerJQLike) {
    ...
    $scope.createNewEvent = function(eventName, eventDescription, startDate, endDate) {
      // $state.go('home');
